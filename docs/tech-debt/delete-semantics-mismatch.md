...
| 상태 | **✅ 두 건 모두 해소 (2026-09-15)** — QA-02 `a84b227` / QA-01 S1~S7 (선택지 **A 확장판**: soft delete 전면 폐지). 후속 **QA-29(단계적 삭제)도 완료** — 배치 7일 유예 + 가이드 삭제 영향 고지. **탈퇴는 유예 0일로 확정**(미착수 아님, 아래 참조) (정본 = `docs-private/FOLLOWUP_QUEUE.md`) |
|---|---|
